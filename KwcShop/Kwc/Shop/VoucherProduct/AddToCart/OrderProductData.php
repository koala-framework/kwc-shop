<?php
class KwcShop_Kwc_Shop_VoucherProduct_AddToCart_OrderProductData extends KwcShop_Kwc_Shop_AddToCartAbstract_OrderProductData
{
    ...
    {
        //gutschein erstellen
        $row = Kwf_Model_Abstract::getInstance('KwcShop_Kwc_Shop_Cart_Plugins_Voucher_Vouchers')->createRow();
