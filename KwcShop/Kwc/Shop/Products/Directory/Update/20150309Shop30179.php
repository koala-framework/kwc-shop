<?php
class KwcShop_Kwc_Shop_Products_Directory_Update_20150309Shop30179 extends Kwf_Update
{
    public function update()
    {
        $db = Kwf_Registry::get('db');
        $executed = $db->fetchOne("SHOW columns FROM `kwc_shop_orders` LIKE 'payment_component_id'");
        if ($executed) return;
