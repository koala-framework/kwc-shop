<?php
class KwcShop_Kwc_Shop_Products_Directory_Component extends Kwc_Directories_ItemPage_Directory_Component
{
    public static function getSettings($param = null)
    {
        $ret = parent::getSettings($param);
        $ret['generators']['child']['component']['view'] = 'KwcShop_Kwc_Shop_Products_View_Component';

        $ret['menuConfig'] = 'Kwf_Component_Abstract_MenuConfig_SameClass';

        $ret['generators']['detail']['class'] = 'KwcShop_Kwc_Shop_Products_Directory_Generator';
        $ret['generators']['detail']['component'] = 'KwcShop_Kwc_Shop_Products_Detail_Component';
        $ret['generators']['detail']['dbIdShortcut'] = 'shopProducts_';

        $ret['generators']['addToCart'] = array(
            'class' => 'Kwf_Component_Generator_Table',
            'component' => 'KwcShop_Kwc_Shop_Products_Directory_AddToCart_Component'
        );

        $ret['childModel'] = 'KwcShop_Kwc_Shop_Products';
