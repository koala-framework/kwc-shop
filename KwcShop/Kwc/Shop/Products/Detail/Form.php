<?php
class KwcShop_Kwc_Shop_Products_Detail_Form extends Kwc_Directories_Item_Detail_Form
{
    private $_cards;
    private $_fieldSet;
    ...
    protected function _init()
    {
        ...
        $mf->setModel(Kwf_Model_Abstract::getInstance('KwcShop_Kwc_Shop_ProductPrices'));
