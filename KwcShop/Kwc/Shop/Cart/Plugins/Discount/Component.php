<?php
class KwcShop_Kwc_Shop_Cart_Plugins_Discount_Component extends Kwf_Component_Plugin_Abstract
    implements KwcShop_Kwc_Shop_Cart_Plugins_Interface
{
    ...
    public function getPlaceholders(KwcShop_Kwc_Shop_Cart_Order $order) { return array(); }
