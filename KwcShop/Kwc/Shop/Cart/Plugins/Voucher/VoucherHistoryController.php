<?php
class KwcShop_Kwc_Shop_Cart_Plugins_Voucher_VoucherHistoryController extends Kwf_Controller_Action_Auto_Grid
{
    protected $_modelName = 'KwcShop_Kwc_Shop_Cart_Plugins_Voucher_VoucherHistory';
