<?php
class KwcShop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_LogModel extends Kwf_Model_Db
{
    protected $_table = 'kwc_wirecard_log';
    protected $_rowClass = 'KwcShop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_LogRow';
