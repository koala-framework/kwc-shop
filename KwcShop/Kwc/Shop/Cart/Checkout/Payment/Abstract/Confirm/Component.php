<?php
class KwcShop_Kwc_Shop_Cart_Checkout_Payment_Abstract_Confirm_Component extends Kwc_Editable_Component
{
    private $_order;
    ...
    public function processInput($data)
    {
        ...
        if (!$o) {
            ...
            header("Location: ".$this->getData()->getParentByClass('KwcShop_Kwc_Shop_Cart_Checkout_Component')->url);
            exit;
        }
