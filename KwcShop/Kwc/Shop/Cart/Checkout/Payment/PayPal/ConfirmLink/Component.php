<?php
class KwcShop_Kwc_Shop_Cart_Checkout_Payment_PayPal_ConfirmLink_Component extends Kwc_Abstract
{
...
//            'lc' => 'AT',
    ...
    protected function _getPaypalButton()
    {
        ...
        $payment = $this->getData()->getParentByClass('KwcShop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Component');
