<?php
class KwcShop_Kwc_Shop_Cart_Checkout_Payment_PayPal_ConfirmLink_Trl_Component extends Kwc_Chained_Trl_Component
{
    ...
    protected function _getPaypalButton()
    {
        ...
        $payment = $this->getData()->getParentByClass('KwcShop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Trl_Component');
        ...
        return KwcShop_Kwc_Shop_Cart_Checkout_Payment_PayPal_ConfirmLink_Component::buildPayPalButtonHtml($params, $payment, $order);
    }
}
