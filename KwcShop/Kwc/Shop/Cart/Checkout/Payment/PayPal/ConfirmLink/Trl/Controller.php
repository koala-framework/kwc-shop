<?php
class KwcShop_Kwc_Shop_Cart_Checkout_Payment_PayPal_ConfirmLink_Trl_Controller extends Zend_Controller_Action
{
    ...
    public function jsonConfirmOrderAction()
    {
        ...
        if ($order && $component &&
            is_instance_of($component->componentClass, 'KwcShop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Trl_Component')
        ) {
