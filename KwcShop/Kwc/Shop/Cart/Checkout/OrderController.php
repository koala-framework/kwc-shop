<?php
class KwcShop_Kwc_Shop_Cart_Checkout_OrderController extends Kwf_Controller_Action_Auto_Form
{
        ...
        foreach (Kwc_Abstract::getComponentClasses() as $c) {
            ...
            if (isset($g['checkout']) && $g['checkout']['component']['checkout'] == $this->_getParam('class')) {
                foreach (Kwc_Abstract::getSetting($c, 'plugins') as $p) {
                    if (is_instance_of($p, 'KwcShop_Kwc_Shop_Cart_Plugins_Interface')) {
                        $p = new $p();
