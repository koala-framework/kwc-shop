<?php
class Shop_Kwc_Shop_AddToCart_OrderProductData extends Shop_Kwc_Shop_AddToCartAbstract_OrderProductData
{
    ...
    public function alterBackendOrderForm(Shop_Kwc_Shop_AddToCartAbstract_FrontendForm $form)
    {
        $component = null;
        foreach (Kwc_Abstract::getComponentClasses() as $c) {
            if (is_instance_of($c, 'Shop_Kwc_Shop_Products_Directory_Component')) {
        ...
        $m = Kwf_Model_Abstract::getInstance('Shop_Kwc_Shop_Products');
        $s = $m->select();
