<?php
class Shop_Kwc_Shop_Products_Directory_Component extends Kwc_Directories_ItemPage_Directory_Component
{
    public static function getSettings($param = null)
    {
        ...
        $ret['generators']['detail']['class'] = 'Shop_Kwc_Shop_Products_Directory_Generator';
        $ret['generators']['detail']['component'] = 'Shop_Kwc_Shop_Products_Detail_Component';
        $ret['generators']['detail']['dbIdShortcut'] = 'shopProducts_';

        $ret['generators']['addToCart'] = array(
            'class' => 'Kwf_Component_Generator_Table',
            'component' => 'Shop_Kwc_Shop_Products_Directory_AddToCart_Component'
        );

        $ret['childModel'] = 'Shop_Kwc_Shop_Products';
