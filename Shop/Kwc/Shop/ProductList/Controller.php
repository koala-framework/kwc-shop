<?php
class Shop_Kwc_Shop_ProductList_Controller extends Kwf_Controller_Action_Auto_Kwc_Form
{
    public function _initFields()
    {
        ...
        foreach (Kwc_Abstract::getComponentClasses() as $class) {
            if (is_instance_of($class, 'Shop_Kwc_Shop_Products_Directory_Component')) {
