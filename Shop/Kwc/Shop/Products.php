<?php
class Shop_Kwc_Shop_Products extends Kwf_Model_Db
{
    protected $_rowClass = 'Shop_Kwc_Shop_Product';
    protected $_table = 'Shop_Kwc_Shop_products';
    protected $_filters = array('pos');
    protected $_dependentModels = array(
        'Prices' => 'Shop_Kwc_Shop_ProductPrices'
    );
