<?php
class Shop_Kwc_Shop_Cart_Plugins_Voucher_Redeem_Component extends Kwc_Form_Component
{
    public static function getSettings($param = null)
    {
        $ret = parent::getSettings($param);
        $ret['generators']['child']['component']['success'] = 'Shop_Kwc_Shop_Cart_Plugins_Voucher_Redeem_Success_Component';
    ...
    {
        parent::_initForm();
        $this->_form->setId(Shop_Kwc_Shop_Cart_Orders::getCartOrderId());
    }
