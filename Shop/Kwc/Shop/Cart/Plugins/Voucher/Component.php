<?php
class Shop_Kwc_Shop_Cart_Plugins_Voucher_Component extends Kwf_Component_Plugin_Abstract
    implements Shop_Kwc_Shop_Cart_Plugins_Interface
{
    public static function getSettings($param = null)
    {
        ...
        $ret['extConfig'] = 'Shop_Kwc_Shop_Cart_Plugins_Voucher_ExtConfig';
        $ret['menuConfig'] = 'Shop_Kwc_Shop_Cart_Plugins_Voucher_MenuConfig';
        return $ret;
    }
    ...
    public function getAdditionalSumRows($order, $total)
    {
        ...
        if ($order->voucher_amount) {
            ...
            $row = Kwf_Model_Abstract::getInstance('Shop_Kwc_Shop_Cart_Plugins_Voucher_Vouchers')->getRow($s);
