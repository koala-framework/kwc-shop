<?php
class Shop_Kwc_Shop_Cart_Checkout_Form_Component extends Kwc_Form_Component
{
    public static function getSettings($param = null)
    {
        $ret = parent::getSettings($param);
        $ret['generators']['child']['component']['success'] = 'Shop_Kwc_Shop_Cart_Checkout_Form_Success_Component';
    ...
    protected function _initForm()
    {
        ...
        $this->_form->setId(Shop_Kwc_Shop_Cart_Orders::getCartOrderId()); //can be null
    ...
    protected function _afterInsert(Kwf_Model_Row_Interface $row)
    {
        ...
        Shop_Kwc_Shop_Cart_Orders::setCartOrderId($row->id);
    }
    ...
    protected function _getFrontendPayments()
    {
        ...
        foreach ($cc as $k=>$c) {
            if ($totalAmount <= 0) {
                if (is_instance_of($c, 'Shop_Kwc_Shop_Cart_Checkout_Payment_None_Component')) {
