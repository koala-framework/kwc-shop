<?php
class Shop_Kwc_Shop_Cart_Checkout_Form_Trl_Component extends Kwc_Form_Trl_Component
{
    ...
    {
        return Kwf_Model_Abstract::getInstance(Kwc_Abstract::getSetting($this->getData()->getParentByClass('Shop_Kwc_Shop_Cart_Trl_Component')->chained->componentClass, 'childModel'))
