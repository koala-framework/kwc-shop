<?php
class Shop_Kwc_Shop_Cart_Checkout_Component extends Kwc_Abstract_Composite_Component
{
    public static function getSettings($param = null)
    {
        $ret = parent::getSettings($param);
        $ret['componentName'] = trlKwfStatic('Orders');
        $ret['generators']['child']['component']['form'] = 'Shop_Kwc_Shop_Cart_Checkout_Form_Component';

        $ret['generators']['payment'] = array(
            'class' => 'Kwf_Component_Generator_PseudoPage_Static',
            'component' => array(
                'prePayment' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_PrePayment_Component',
                'cashOnDelivery' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_CashOnDelivery_Component',
                'payPal' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Component',
                'none' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_None_Component'
            )
        );
        ...
        $ret['menuConfig'] = 'Shop_Kwc_Shop_Cart_Checkout_MenuConfig';
