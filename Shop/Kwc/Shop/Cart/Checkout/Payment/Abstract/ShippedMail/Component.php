<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_ShippedMail_Component extends Kwc_Mail_Editable_Component
{
    public static function getSettings($param = null)
    {
        $ret = parent::getSettings($param);
        $ret['generators']['content']['component'] = 'Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_ShippedMail_Paragraphs_Component';
        return $ret;
    }
    ...
    {
        return array(
            'ord' => get_class(Kwf_Model_Abstract::getInstance(Kwc_Abstract::getSetting($this->getData()->getParentByClass('Shop_Kwc_Shop_Cart_Component')->componentClass, 'childModel'))
