<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_Component extends Kwc_Abstract_Composite_Component
{
    public static function getSettings($param = null)
    {
        ...
        $ret['generators']['child']['component']['orderHeader'] = 'Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_OrderHeader_Component';
        $ret['generators']['child']['component']['orderTable'] = 'Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_OrderTable_Component';
        $ret['generators']['child']['component']['confirmLink'] = 'Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_ConfirmLink_Component';

        $ret['generators']['confirm'] = array(
            'class' => 'Kwf_Component_Generator_Page_Static',
            'component' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_Confirm_Component',
            'name' => trlKwfStatic('Send order')
        );

        $ret['generators']['mail'] = array(
            'class' => 'Kwf_Component_Generator_Page_Static',
            'component' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_Mail_Component',
        );
        $ret['generators']['shippedMail'] = array(
            'class' => 'Kwf_Component_Generator_Page_Static',
            'component' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_ShippedMail_Component',
        );

        $ret['orderData'] = 'Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_OrderData';
    ...
    {
        return Kwf_Model_Abstract::getInstance(Kwc_Abstract::getSetting($this->getData()->getParentByClass('Shop_Kwc_Shop_Cart_Component')->componentClass, 'childModel'))
    ...
    public function sendConfirmMail(Shop_Kwc_Shop_Cart_Order $order)
    {
    ...
    public function confirmOrder($order)
    {
        ...
        foreach ($order->getChildRows('Products') as $p) {
            $addComponent = Shop_Kwc_Shop_AddToCartAbstract_OrderProductData::getAddComponentByDbId(
