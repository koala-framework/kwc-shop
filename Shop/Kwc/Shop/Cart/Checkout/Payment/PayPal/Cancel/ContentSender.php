<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Cancel_ContentSender extends Kwf_Component_Abstract_ContentSender_Default
{
    public function sendContent($includeMaster)
    {
        $session = new Kwf_Session_Namespace('kwcShopCart');
        if ($session->paypalCartId) {
            Shop_Kwc_Shop_Cart_Orders::setCartOrderId($session->paypalCartId);
