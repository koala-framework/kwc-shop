<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_ConfirmLink_Controller extends Zend_Controller_Action
{
    ...
    public function jsonConfirmOrderAction()
    {
        ...
        if ($order && $component &&
            is_instance_of($component->componentClass, 'Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Component')
        ) {
