<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Component extends Shop_Kwc_Shop_Cart_Checkout_Payment_Abstract_Component
{
    public static function getSettings($param = null)
    {
        $ret = parent::getSettings($param);
        $ret['componentName'] = trlKwfStatic('PayPal');
        $ret['generators']['child']['component']['confirmLink'] = 'Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_ConfirmLink_Component';
        $ret['generators']['confirm']['component'] = 'Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Confirm_Component';
        $ret['generators']['confirm']['name'] = trlKwfStatic('done');
        $ret['generators']['ipn'] = array(
            'class' => 'Kwf_Component_Generator_Page_Static',
            'component' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Ipn_Component'
        );
        $ret['generators']['cancel'] = array(
            'class' => 'Kwf_Component_Generator_Page_Static',
            'component' => 'Shop_Kwc_Shop_Cart_Checkout_Payment_PayPal_Cancel_Component',
