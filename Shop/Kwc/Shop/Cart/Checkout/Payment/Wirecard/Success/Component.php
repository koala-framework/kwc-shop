<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_Success_Component extends Kwc_Editable_Component
{
    ...
    public function processInput($data)
    {
        ...
        $data = Shop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_LogModel::decodeCallback($custom);
        if ($data) {
