<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_ConfirmLink_Trl_Controller extends Zend_Controller_Action
{
    ...
    public function jsonConfirmOrderAction()
    {
        ...
        if ($order && $component &&
            is_instance_of($component->componentClass, 'Shop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_Trl_Component')
        ) {
