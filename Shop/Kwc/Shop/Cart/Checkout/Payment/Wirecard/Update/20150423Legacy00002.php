<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_Update_20150423Legacy00002 extends Kwf_Update
{
    public function update()
    {
        ...
        $ordersModel = Kwf_Model_Abstract::getInstance('Shop_Kwc_Shop_Cart_Orders');
        $logModel = Kwf_Model_Abstract::getInstance('Shop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_LogModel');
