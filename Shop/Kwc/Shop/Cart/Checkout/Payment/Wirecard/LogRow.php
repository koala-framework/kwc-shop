<?php
class Shop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_LogRow extends Kwf_Model_Db_Row
{
    protected function _afterInsert()
    {
        parent::_afterInsert();
        $c = Shop_Kwc_Shop_Cart_Checkout_Payment_Wirecard_LogModel::decodeCallback($this->custom);
        if ($c && $c['cb']) {
            $ret = false;
