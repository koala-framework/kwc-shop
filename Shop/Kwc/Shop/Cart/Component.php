<?php
class Shop_Kwc_Shop_Cart_Component extends Kwc_Directories_Item_Directory_Component
{
    ...
    public static function getSettings($param = null)
    {
        ...
        $ret['generators']['child']['component']['form'] = 'Shop_Kwc_Shop_Cart_Form_Component';
        $ret['generators']['child']['component']['view'] = 'Shop_Kwc_Shop_Cart_View_Component';
        $ret['generators']['detail']['class'] = 'Shop_Kwc_Shop_Cart_Generator';
        $ret['generators']['detail']['component'] = 'Shop_Kwc_Shop_Cart_Detail_Component';
        $ret['childModel'] = 'Shop_Kwc_Shop_Cart_OrderProducts';
        $ret['generators']['checkout'] = array(
            'class' => 'Kwf_Component_Generator_Page_Static',
            'component' => 'Shop_Kwc_Shop_Cart_Checkout_Component',
        ...
        $ret['contentSender'] = 'Shop_Kwc_Shop_Cart_ContentSender';
