<?php
class Shop_Kwc_Shop_Cart_Detail_Component extends Kwc_Abstract_Composite_Component
{
    public static function getSettings($param = null)
    {
        $ret = parent::getSettings($param);
        $ret['generators']['child']['component']['form'] = 'Shop_Kwc_Shop_Cart_Detail_Form_Component';
        $ret['viewCache'] = false;
    ...
    public function getTemplateVars(Kwf_Component_Renderer_Abstract $renderer)
    {
        ...
        $addCmp = Shop_Kwc_Shop_AddToCartAbstract_OrderProductData::getAddComponentByDbId(
    ...
    {
        return Shop_Kwc_Shop_AddToCartAbstract_OrderProductData::getAddComponentByDbId(
            $this->getData()->row->add_component_id, $this->getData()
        );
