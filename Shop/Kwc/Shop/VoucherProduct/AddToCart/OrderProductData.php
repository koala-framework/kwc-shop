<?php
class Shop_Kwc_Shop_VoucherProduct_AddToCart_OrderProductData extends Shop_Kwc_Shop_AddToCartAbstract_OrderProductData
{
    ...
    {
        //gutschein erstellen
        $row = Kwf_Model_Abstract::getInstance('Shop_Kwc_Shop_Cart_Plugins_Voucher_Vouchers')->createRow();
